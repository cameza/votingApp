class NomineesController < ApplicationController
  ...
  private
    ...
    def nominee_params
      params.require(:nominee).permit(:nominee_mail, :nominee_name, :cv, :statement, :committee_check, :committee_check_count, :chairman_check, :confirmed, :not_confirmed, :abstained)
    end
end
